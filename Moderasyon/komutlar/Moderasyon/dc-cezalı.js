...
`)
            await dcInterval.findOne({
                ...
                if (!data) {
                    ...
                    await banSistemi(message, messageEmbed, client,  target, cezaID, reason, args, ms, JailROL, data);
...
async function banSistemi(message, messageEmbed, client, target, cezaID, reason, args, ms, JailROL, booster) {
