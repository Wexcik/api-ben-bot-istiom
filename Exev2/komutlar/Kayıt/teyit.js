...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    if (message.member.permissions.has(8n) || message.guild.roles.cache.some(rol => kayitSorumlusu.some(rol2 => rol === rol2)) || message.guild.roles.cache.some(rol => jailSorumluRol.some(rol2 => rol === rol2)) || durum) {
