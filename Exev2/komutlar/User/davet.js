...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    Database.findOne({
        ...
        if (!inviterData) {
            ...
            embed.setDescription(`Toplam **0** davetin var!! (**0** gerçek, **0** bonus, **0** fake, **0** haftalık)`);
            ...
            Database.find({
                ...
                embed.setDescription(`Toplam **${inviterData.regular+inviterData.bonus}** davetin var! (**${inviterData.regular}** gerçek, **${inviterData.bonus}** bonus, **${inviterData.fake}** fake, **${dailyInvites}** haftalık)`);
            message.channel.send({embeds: [embed]});
});
        };
    });
