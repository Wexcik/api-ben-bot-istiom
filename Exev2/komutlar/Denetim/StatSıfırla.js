...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    if (sec == "üye") {
        ...
        return message.reply(`${client.emojis.cache.find(x => x.name === "wex_tik")} Başarılı bir şekilde ${target} adlı kullanıcının puanlarını sıfırladınız.`)
    }
    if (sec == "rol") {
        ...
        return message.reply(`${client.emojis.cache.find(x => x.name === "wex_tik")} Başarılı bir şekilde <@&${rol.id}> adlı rolündeki üyelerin puanlarını sıfırladınız.`)
    }
}
exports.conf = {
